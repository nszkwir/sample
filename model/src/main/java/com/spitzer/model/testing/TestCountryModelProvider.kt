...
object TestCountryModelProvider {
    fun getTestCountryModel(cca3: String? = null, name: String? = null, tags: String? = null) =
        CountryModel(
            ...
            tags = tags ?: "Argentina Republica Argentina Buenos Aires Tango Messi Maradona".lowercase(),
            ...
            countryNameTranslations = mapOf<String, CountryModel.NameValues>(
                ...
                Pair(
                    "fra",
                    CountryModel.NameValues(
                        official = "Le Republique Argentine",
                        common = "Argentine"
                    )
                ),
                Pair(
